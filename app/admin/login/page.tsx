      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 border border-amber-200">
        ...
        <form onSubmit={handleLogin}>
          ...
          <input
            ...
            className="w-full mt-1 mb-4 px-4 py-2 rounded-lg border border-amber-300 text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
            required
          />
          ...
          <input
            ...
            className="w-full mt-1 mb-6 px-4 py-2 rounded-lg border border-amber-300 text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
            required
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-2.5 rounded-lg shadow-sm font-semibold text-white transition ${
              loading
